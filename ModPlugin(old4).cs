...
namespace TestMod
{
    public class ModPlugin : GamePlugin
    {
        ...
        //Steam workshop ID
        public static ulong SteamWorkshopID { get; } = 0;
        ...
        public void OnLoad()
        {
            UseSteam = SteamInterface.UseSteam && SteamWorkshopID != 0;
        ...
        private void SteamUGCRequest(ITimeStep t)
        {
            if (UseSteam && ++RequestCount <= 4)
            {
                ...
                SteamAPICall_t UGCDetails = SteamUGC.RequestUGCDetails(new PublishedFileId_t(SteamWorkshopID), 0);
