...
public class SyncroniseBlock : Block, IBlockWithText
{
    ...
    private string SyncroniseDelimiter = "#=Delimiter9128347=#";
    ...
    public void SyncroniseDataUpLoad()
    {
        ...
        string NewSyncroniseData = String.Join(",", ExtraInfoArrayWritePackage.DataArray.Select(D => D.ToString()).ToArray()) + SyncroniseDelimiter + GetText();
    ...
    public override void SyncroniseUpdate(string NewSyncroniseData)
    {
        ...
        {
            SyncroniseData = NewSyncroniseData;
            string[] SDA = SyncroniseData.Split(new string[] { SyncroniseDelimiter }, StringSplitOptions.None);
